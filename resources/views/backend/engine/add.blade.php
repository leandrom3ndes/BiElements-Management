...
<div class="col-sm-12 mb-4">
    <h3 class="border-bottom pb-1 mb-2">Add Engine
...
<div class="col-sm-12 mb-4">
    ...
    @endif
    <form method="post" action="{{ url('admin/engine/add') }}" enctype="multipart/form-data">
    {{ csrf_field() }}
    <table class="table table-bordered">
        <tr>
            <th>Engine Title</th>
            <td>
                <input type="text" name="eng_name" class="form-control" placeholder="Enter Engine Name" />
        ...
        <tr>
            ...
            <td>
                <textarea name="eng_desc" placeholder="Enter Engine Description" class="form-control" cols="30" rows="10"></textarea>
