...
<div class="col-sm-12 mb-4">
    <h3 class="border-bottom pb-1 mb-2">Edit Book
...
<div class="col-sm-12 mb-4">
    ...
    <table class="table table-bordered">
        ...
        <tr>
            <th>Book Name</th>
            <td>
                <input type="text" value="{{ $allData->book_name }}" name="book_name" class="form-control" placeholder="Enter Book Name" />
        ...
        <tr>
            ...
            <td>
                ...
                <input type="hidden" name="book_pdf" value="{{ $allData->book_pdf }}">
                <img width="100" src="{{ asset('storage/books/'.$allData->book_pdf) }}" alt="">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="hidden" name="prev_img" value="{{ $allData->book_cover_img }}">
                <img width="100" src="{{ asset('storage/books/'.$allData->book_cover_img) }}" alt="">
        ...
        <tr>
            <th>Book Price</th>
            <td>
                <input type="text" value="{{ $allData->book_price }}" name="book_price" class="form-control" placeholder="Enter Book Price" />
        ...
        <tr>
            <th>Book Author</th>
            <td>
                <input type="text" value="{{ $allData->book_author }}" name="book_author" class="form-control" placeholder="Enter Book Author" />
        ...
        <tr>
            ...
            <td>
                <input type="text" value="{{ $allData->book_publisher }}" name="book_publisher" class="form-control" placeholder="Enter Book Publisher" />
        ...
        <tr>
            ...
            <td>
                <input type="date" value="{{ $allData->book_publish_date }}" name="book_publish" class="form-control" placeholder="Enter Book Publish Date" />
        ...
        <tr>
            ...
            <td>
                <textarea name="book_desc" class="form-control" placeholder="Enter Book Description" id="" cols="30" rows="10">{{ $allData->book_desc }}</textarea>
